...
"""Evo_Client Class Ex-Members
    ...
    def OLD_publish_filenames(self):
        ...
        sim.simxSetStringSignal(self.clientID,'Path_To_Files', raw_ubytes_path, mode1)
        sim.simxSetIntegerSignal(self.clientID, 'n_Genomes', len(self.genomes), mode1)
        ...
        for i, (genome, filename) in enumerate(zip(self.genomes, self.genome_filenames)):
            ...
            sim.simxSetStringSignal(self.clientID, ('Genome_File_Name_' + str(i)), raw_ubytes_filename, mode1)
    ...
    def OLD_add_genome(self, a_genome):
        ...
        sim.simxGetFloatSignal(self.clientID, 'FitnessScore_' + str(genome_ID), mode4)
