...
class EvoProject(object):
    __slots__ = 'mpl_monitor', 'exp_title', 'exp_subtitle', 'pdf_filename', \
                ...
                'genomes_per_client', 'client_ip', 'client_count', 'genomes_per_generation', 'path_to_gene_pool', \
                'nn_in', 'nn_hidden', 'nn_outs', 'nn_start_minimal'
    ...
    def __init__(self, project_name):
        ...
        self.genomes_per_generation = config.getint('Training', 'genomes_per_generation')
